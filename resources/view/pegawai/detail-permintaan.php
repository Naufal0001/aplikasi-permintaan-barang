...
if (!isset($_SESSION["login"])) {
    ...
    if (isset($_GET['tgl'])) {
        $tgl = $_GET['tgl'];
        $query = mysqli_query($conn, "SELECT permintaan.id_permintaan, permintaan.kode_brg, nama_barang, jumlah, satuan, status FROM permintaan INNER JOIN barang ON permintaan.kode_brg = barang.kode_brg  WHERE tgl_permintaan = '$tgl' AND divisi = '$_SESSION[login]'");
            ...
            <div class="mx-auto max-w-screen-xl">
                ...
                <div class="bg-white relative shadow-md rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto p-4">
                        <div class="flex mb-4">
                            <a href="data-permintaan.php" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2.5"><i class='fa fa-backward mr-2'></i>Kembali</a>
                        </div>
